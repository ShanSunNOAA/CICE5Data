...
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cfsr_run/basin8_cfsr_sie_ic_201310.txt; cfsr(1,:,:)=basin8_cfsr_sie_ic_201310;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cfsr_run/basin8_cfsr_sie_ic_201410.txt; cfsr(2,:,:)=basin8_cfsr_sie_ic_201410;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cfsr_run/basin8_cfsr_sie_ic_201510.txt; cfsr(3,:,:)=basin8_cfsr_sie_ic_201510;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cfsr_run/basin8_cfsr_sie_ic_201610.txt; cfsr(4,:,:)=basin8_cfsr_sie_ic_201610;

load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cryo_run/basin8_cryo_sie_ic_201310.txt; cryo(1,:,:)=basin8_cryo_sie_ic_201310;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cryo_run/basin8_cryo_sie_ic_201410.txt; cryo(2,:,:)=basin8_cryo_sie_ic_201410;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cryo_run/basin8_cryo_sie_ic_201510.txt; cryo(3,:,:)=basin8_cryo_sie_ic_201510;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cryo_run/basin8_cryo_sie_ic_201610.txt; cryo(4,:,:)=basin8_cryo_sie_ic_201610;
...
title ('(a) Ice Extent (10$^6$km$^2$, IC=1 Oct 2013-2017)','Interpreter','latex')
axis off
...
%print -djpeg sie_8basin_aprIC.jpg
print -depsc2 fig11_sie_8basin_octIC.eps
%print -dpdf fig10_sie_8basin_aprIC.pdf
