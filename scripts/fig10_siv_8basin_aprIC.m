...
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cfsr_run/basin8_cfsr_siv_ic_201204.txt; cfsr(1,:,:)=basin8_cfsr_siv_ic_201204;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cfsr_run/basin8_cfsr_siv_ic_201304.txt; cfsr(2,:,:)=basin8_cfsr_siv_ic_201304;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cfsr_run/basin8_cfsr_siv_ic_201404.txt; cfsr(3,:,:)=basin8_cfsr_siv_ic_201404;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cfsr_run/basin8_cfsr_siv_ic_201504.txt; cfsr(4,:,:)=basin8_cfsr_siv_ic_201504;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cfsr_run/basin8_cfsr_siv_ic_201604.txt; cfsr(5,:,:)=basin8_cfsr_siv_ic_201604;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cfsr_run/basin8_cfsr_siv_ic_201704.txt; cfsr(6,:,:)=basin8_cfsr_siv_ic_201704;

load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cryo_run/basin8_cryo_siv_ic_201204.txt; cryo(1,:,:)=basin8_cryo_siv_ic_201204;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cryo_run/basin8_cryo_siv_ic_201304.txt; cryo(2,:,:)=basin8_cryo_siv_ic_201304;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cryo_run/basin8_cryo_siv_ic_201404.txt; cryo(3,:,:)=basin8_cryo_siv_ic_201404;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cryo_run/basin8_cryo_siv_ic_201504.txt; cryo(4,:,:)=basin8_cryo_siv_ic_201504;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cryo_run/basin8_cryo_siv_ic_201604.txt; cryo(5,:,:)=basin8_cryo_siv_ic_201604;
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/cryo_run/basin8_cryo_siv_ic_201704.txt; cryo(6,:,:)=basin8_cryo_siv_ic_201704;
...
load /scratch2/BMC/gsd-fv3-dev/sun/cice_result/obs/basin8_siv_obs_2017.txt; vobs(6,:,:)=basin8_siv_obs_2017;
...
title ('(b) Ice Volume (10$^3$km$^3$, IC=1 Apr 2013-2017)','Interpreter','latex')
axis off
...
print -depsc2 fig10_siv_8basin_aprIC.eps
